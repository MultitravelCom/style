            ...
            <div key={destino.id} className="carrusel__elemento">
                <div className="main__conteiner__s1__destacado__card uno" style={{ height: "100%", width: "100%" }}>
                    ...
                    <div className="main__container__buttonsCars">
                        <Button id={destino.id} className="btn_Style_Venta_Per classOpenModal" text="Contactarme" />
                        <Button id={destino.title} className="btn_Style_Venta_Per__FormBitrix" text="Agendar llamada" onClick={() => onContactClick(destino.id)} />
                    </div>
                </div>
            </div>
        )));
