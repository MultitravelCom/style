...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const handleCheckboxSelection = () => {
        const departureCheckbox = document.querySelectorAll('input[name="result-option-radio-departure"]:checked');
        const returnCheckbox = document.querySelectorAll('input[name="result-option-radio-return"]:checked');
    ...
    const departureCheckbox = document.querySelectorAll('input[name="result-option-radio-departure"]');
    const returnCheckbox = document.querySelectorAll('input[name="result-option-radio-return"]');
