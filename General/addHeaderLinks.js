function addHeaderLinks() {
    ...
    if (path.includes('/results') || path.includes('/details') || path.includes('/flights/booking') || path.includes('/hotels/booking') || path.includes('/booking') || path.includes('/results.aspx')) {
